...
public class AddDialogFragment extends DialogFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUsername = getArguments().getString(USERNAME_IN_ADD_FRAGMENT);
        mTask = new Task("task", 0, "description", mUsername);
    }
            ...
            public void onClick(View view) {
                ...
                || mEditTextDescription.getText().toString().length()==0){
                    ...
                    if(mRadioButtonTodo.isChecked()){
                        ...
                        mAppRepository.mITaskDatabaseDao().insertTask(mTask);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == DATE_PICKER_REQUEST_CODE) {
            ...
            mAppRepository.mITaskDatabaseDao().updateTask(mTask);
        }
    }
